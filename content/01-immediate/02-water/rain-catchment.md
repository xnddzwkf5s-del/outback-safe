+++
title = "Rain Catchment — Harvesting the Sky"
description = "Improvised rain collection using tarps, natural materials, roofing, and containers. The safest natural water source if collected cleanly."
date = 2026-07-22
weight = 4
+++
...
- **Lowest contamination risk** — no ground pathogens, no animal waste
- **Requires minimal treatment** — filtration for debris, then boiling or SODIS if collection surface was dirty
- **No energy input** once the collection system is built
- **Available in large quantities** — 1 mm of rain on 1 m² = 1 litre of water

---

## Setup 1: Simple Slope Tarp (Fastest to Deploy)
...
- Setup: 5–10 minutes
- Yield: 1 L per mm of rain per m² of tarp area

---

## Setup 2: Bowl/Trough Tarp (Maximum Catchment Area)
...
The bowl setup catches more area but is **vulnerable to wind**. Add extra tie-downs at the midpoints of each side. In strong wind, lower the tarp or switch to the slope setup (less wind profile).

### Time Required

- Setup: 10–15 minutes
- Yield: 1 L per mm of rain per m² of tarp area (same as slope, but larger tarp possible)

### Comparison: Slope vs Bowl

| | Slope Setup | Bowl Setup |
|---|-------------|------------|
| **Speed to deploy** | Fast (5 min) | Moderate (10–15 min) |
| **Wind resistance** | Good | Poor — catches wind |
| **Collection efficiency** | Good | Excellent |
| **Debris accumulation** | Low | Moderate (leaves, dirt pool in centre) |
| **Best for** | Quick setup, windy conditions | Large volume, calm conditions |

---

## Natural Rain Catchment Methods
...
## Building and Vehicle Catchment

### Roof Catchment (Intact Buildings)
...
### Vehicle Roof/Windscreen

- A vehicle's roof and windscreen funnel water to the sides and base of the windscreen
- Park the vehicle on a slight incline — water will channel to the lower corners
- Place containers at the corners of the windscreen where water channels
- The vehicle body is relatively clean compared to ground-level surfaces
- Bonnet (hood) can be propped open at an angle to create an additional collection surface

---

## First-Flush Diversion

The first rain after a dry period washes accumulated dust, bird droppings, leaves, and pollutants off the collection surface. This "first flush" should be discarded.
...
After the rain event, empty and clean the first-flush container so it is ready for next time. If left full, it becomes a mosquito breeding site.

### Time Required

- Setup: 5 minutes
- Maintenance: 1 minute after each rain event

---

## Keeping Rainwater Clean

- **Clean collection surface** before rain — sweep debris, brush off droppings
- **Cover collection containers** — mesh, cloth, or a lid with a small entry hole prevents debris, insects, and animals
- **Store in opaque or covered containers** — sunlight + clear container = algae growth
- **Use collected water within 3–5 days** if stored in warm conditions without treatment
- **Treat stored rainwater** with a few drops of bleach if storing more than a week (see [Water Storage](01-immediate/02-water/water-storage))
- **Do not collect from surfaces with lead paint, treated timber, or chemical residue**

---

## Calculating Collection Potential

| Roof/tarp area | 1 mm rain | 10 mm rain | 50 mm rain (monsoon downpour) |
|----------------|-----------|------------|-------------------------------|
| 1 m² (small tarp) | 1 L | 10 L | 50 L |
| 2 m² (emergency blanket) | 2 L | 20 L | 100 L |
| 4 m² (medium tarp) | 4 L | 40 L | 200 L |
| 10 m² (large tarp/small roof) | 10 L | 100 L | 500 L |
...
## Improvising in a Pinch

| Situation | Solution |
|-----------|----------|
| No tarp, have a rain jacket | Wear jacket, let water funnel down sleeves into bottles |
| Have plastic bags | Cut open bags, tape or tie together to form a sheet |
| Have large leaves only | Overlap leaves shingle-style on a slope — water runs down |
| Have nothing waterproof | Dig a hole, line with large leaves (shingle pattern), let rain fill it |
| Have clothing only | Cloth filters debris but saturates and drips slowly — not efficient |
| Have a space blanket | Excellent — reflective surface is waterproof and large |
...
- [Water Purification](01-immediate/02-water/purification) — treat rainwater if collection surface was dirty
- [Finding Water](01-immediate/02-water/finding-water)
- [Site Selection](01-immediate/03-shelter/site-selection) — position shelter near catchment area
