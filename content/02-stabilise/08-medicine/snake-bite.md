+++
title = "Australian Snake Bite — Definitive Reference"
description = "Comprehensive Australian venomous snake reference. Identification, pressure immobilisation bandage (PIB), symptom timeline, collapse management, hospital treatment, and regional risk by season."
weight = 10
+++
...
For the rapid-action version, see [Outback First Aid — Snake Bite](01-immediate/09-outback/outback-first-aid).
...
{% warning() %}
**NEVER approach a snake to identify it.** These photos are for reference only. If bitten, apply pressure immobilisation bandage and seek emergency help. Do NOT waste time trying to identify the snake — hospital staff will use a Venom Detection Kit.
{% end %}

| Snake | Photo | Distribution | Venom Type | Time to Symptoms | Deadliness |
|-------|-------|-------------|------------|------------------|------------|
| **Eastern Brown** | ![Eastern Brown](/images/snakes/eastern-brown.jpg) | Eastern/central Australia | Neurotoxic + coagulopathic | 15–30 min | Very high |
| **Western Brown** (Gwardar) | ![Western Brown](/images/snakes/western-brown.jpg) | WA, SA, NT | Neurotoxic + coagulopathic | 15–30 min | Very high |
| **Inland Taipan** (Fierce Snake) | ![Inland Taipan](/images/snakes/inland-taipan.jpg) | Channel Country QLD/SA | Neurotoxic (most potent venom) | 30–60 min | Extremely high |
| **Coastal Taipan** | ![Coastal Taipan](/images/snakes/coastal-taipan.jpg) | Coastal QLD, NT top end | Neurotoxic + coagulopathic | 15–30 min | Very high |
| **Tiger Snake** | ![Tiger Snake](/images/snakes/tiger-snake.jpg) | Southern Australia, TAS | Neurotoxic + myotoxic | 30–60 min | High |
| **Death Adder** | ![Death Adder](/images/snakes/death-adder.jpg) | All mainland states | Neurotoxic (paralysis) | 1–6 hours | High |
| **Mulga** (King Brown) | ![Mulga](/images/snakes/mulga-king-brown.jpg) | All mainland except far south | Myotoxic + anticoagulant | Hours | Moderate |
| **Red-bellied Black** | ![Red-bellied Black](/images/snakes/red-bellied-black.jpg) | Eastern Australia | Myotoxic + anticoagulant | Hours | Low (rarely fatal) |
| **Dugite** | ![Dugite](/images/snakes/dugite.jpg) | WA | Neurotoxic + coagulopathic | 30–60 min | Moderate |
| **Copperhead** | ![Copperhead](/images/snakes/copperhead.jpg) | Cooler southern regions | Neurotoxic | Hours | Low-moderate |
...
1. **Keep the victim calm and completely still.** Movement pumps venom through the lymphatic system. Do not let them walk. Do not let them move the bitten limb. This is the single most important non-technical intervention.

2. **DO NOT wash the wound.** Venom remaining on the skin allows hospital staff to identify the species using a Venom Detection Kit (VDK). Washing it away removes this diagnostic evidence.

3. **DO NOT cut, suck, or tourniquet.** These outdated methods cause tissue damage and do not help. Tourniquets can cause limb loss. Cutting the wound introduces infection. Sucking does not remove venom (it is immediately absorbed).

4. **Apply a firm bandage starting OVER the bite site, wrapping UP the limb.** Start by covering the bite point, then bandage distally to proximally (fingers to armpit, or toes to groin). Important: cover the entire limb.
...
5. **Splint the limb to prevent movement.** Any rigid material: SAM splint, branch wrapped in cloth, rolled magazine, tent pole, axe handle. Bind the splint to the bandaged limb. The goal is to prevent joint movement.

6. **Mark the bite site on the bandage with a pen.** Circle the bite site on the outer bandage. This tells hospital staff where to focus without removing the bandage (removing it releases a venom bolus).

7. **Keep the bandage on until at hospital.** Removing the bandage before antivenom is available releases a large amount of venom into the bloodstream — this can cause sudden collapse. The bandage stays on even during evacuation.

8. **If bitten on torso or head:** Apply firm direct pressure over the bite with a large pad and hold in place with a firm bandage. Do not restrict breathing. PIB cannot be applied to the torso — firm pressure is the only option.

### Two-Person PIB Application

If two people are available:
- Person 1: Talks to the victim, keeps them calm, marks the bite site
- Person 2: Applies the bandage and splint
...
{% info() %}
**See also:** [CPR — Basic Life Support](/01-immediate/01-first-aid/cpr) for full CPR duration guidance. The "30 minute" rule does NOT apply to snake bite arrests.
{% end %}
...
- [Outback First Aid](01-immediate/09-outback/outback-first-aid) — Rapid-action version of snake bite PIB, general remote first aid
- [Extreme Heat Survival](01-immediate/09-outback/heat-survival) — Heat illness progression, not to be confused with snake envenomation symptoms
- [Emergency Services](01-immediate/09-outback/emergency-services) — PLB/EPIRB activation, RFDS contact
- [Natural Medicine Database](02-stabilise/08-medicine/herbal/) — Medicinal plants for wound care after snake bite stabilisation
