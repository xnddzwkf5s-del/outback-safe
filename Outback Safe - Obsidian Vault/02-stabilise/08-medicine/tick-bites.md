+++
title = "Tick Bites — Mammalian Meat Allergy"
description = "Australian paralysis tick (Ixodes holocyclus), tick removal technique, tick-borne diseases, and mammalian meat allergy (alpha-gal syndrome)."
weight = 27
+++
...
![Australian Paralysis Tick](images/ticks/tick.jpg)
*Australian Paralysis Tick (Ixodes holocyclus) — before and after feeding. The engorged tick on the right contains approximately 5mL of blood. Image: Wikimedia Commons (CC BY-SA).*

- **Distribution:** Eastern Australia — QLD, NSW, VIC coastal strip, especially the band from Brisbane to Sydney
...
{% warning() %}
**How you remove a tick matters more than anything else.** Incorrect removal causes the tick to inject more venom/saliva, dramatically increasing the risk of paralysis and meat allergy.
{% end %}
...
1. Use **fine-tipped tweezers** or a dedicated **tick removal tool** (available from pharmacies)
2. Grasp the tick **as close to the skin as possible** — behind the head, not the body
3. **Pull straight out** with steady, gentle pressure — do NOT twist or jerk
4. If mouthparts break off: remove what you can, clean the wound, and monitor. The remaining parts will work out on their own or be absorbed over weeks
...
1. Use **Wart-Off aerosol** (dimethyl ether/propane) or similar ether-based freeze spray
2. Hold the spray 1-2cm from the tick and freeze for **10 seconds**
3. Wait for the tick to die
4. **Brush off** — the tick should fall away
...
1. Unsteady gait — walking like a drunk (ataxia)
2. Ascending paralysis — starts in the legs, moves up the body
3. Facial weakness — drooping eyelids, difficulty with facial expressions
4. Difficulty swallowing and slurred speech
...
**Recognition:**
- Symptoms begin within **minutes** of tick attachment (unlike paralysis, which takes days)
...
**This is a medical emergency.** Treat as anaphylaxis:
1. Remove the tick immediately (do not delay for freeze method — the trigger must be removed)
2. Administer adrenaline (EpiPen) — outer mid-thigh
3. Call 000 / activate PLB
4. If no improvement after 5 minutes, give second adrenaline dose
5. Position: lie flat with legs elevated (unless breathing difficulty — then sit supported)
...
See [Anaphylaxis](02-stabilise/08-medicine/anaphylaxis) for complete anaphylaxis management.
...
- [Anaphylaxis](02-stabilise/08-medicine/anaphylaxis) — EpiPen use, severe allergic reaction management
- [Spider Bites](02-stabilise/08-medicine/spider-bites) — Other venomous Australian arthropods
- [Marine Stingers](02-stabilise/08-medicine/marine-stingers) — Marine venom comparison
- [Outback First Aid](01-immediate/09-outback/outback-first-aid) — General first aid for bites and stings
