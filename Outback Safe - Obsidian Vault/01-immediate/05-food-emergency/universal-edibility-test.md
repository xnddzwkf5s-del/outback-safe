+++
title = "Universal Edibility Test — Testing Unknown Plants"
description = "The step-by-step protocol for determining whether an unknown plant is safe to eat. Use only as a last resort."
date = 2026-07-22
weight = 1
+++
...
The Universal Edibility Test (UET) is a systematic protocol for determining whether an unknown plant is safe to eat. It was developed by the military for survival situations where no other food source is available.

**Mortality from UET is rare but possible.** Some plant toxins (e.g., water hemlock, death camas) can kill before the full test is complete. Others cause organ damage that manifests days or weeks later. This is survival medicine, not camping advice.
...
1. **You must have enough water.** The test requires fasting for 8 hours, and some plant reactions cause vomiting/diarrhoea that accelerates dehydration. If you are already dehydrated, do not do this test.
2. **You must have no food allergies** to plants in the same family (if you know the family).
3. **The plant must be abundant.** Testing one plant that is not enough to sustain you is a waste of risk.
4. **You must not be alone.** If you have a severe reaction, you need someone to assist you. If you are alone, the risk is significantly higher.
5. **Only one person tests at a time.** Do not have multiple people test the same plant simultaneously — if it is toxic, everyone is incapacitated at once.

---

## The Protocol — 12 Steps
...
If a plant passes the test raw, it is also safe cooked (generally). If it passes cooked, it may NOT be safe raw. **Boiling is the safest cooking method for unknown plants** — it leaches water-soluble toxins into the water (which you discard).

---

## Limitations and Risks

The UET does NOT detect:

| Risk | Why the test misses it |
|------|----------------------|
| **Cumulative toxins** | Some plant poisons accumulate in the body over weeks (e.g., pyrrolizidine alkaloids in comfrey — liver damage) |
| **Carcinogens** | Long-term cancer risk may take years to manifest |
| **Delayed organ damage** | Kidney or liver toxicity may not produce symptoms for days |
| **Allergic reactions** | An individual may be allergic even to an otherwise edible plant |
| **Teratogens** | Birth defect-causing compounds (critical if pregnant) |
| **Interaction effects** | Some toxins are activated when combined with other foods |

---

## Plants to NEVER Test

Some plants are so toxic that even the skin/mouth tests are dangerous. Do NOT attempt the UET on:

| Plant | Region | Toxin | Effect |
|-------|--------|-------|--------|
| **Gympie-gympie / stinging tree** (*Dendrocnide moroides*) | Eastern Australia | Moroidin | Excruciating pain lasting months; even dried leaves cause reaction |
...
- **You have any other food source** — the test is for genuine starvation scenarios only
- **You are alone** — reactions can be severe and rapid
- **You are already weak from dehydration or hunger** — your body cannot handle additional stress
- **The plant is a mushroom** — UET is not reliable for fungi
- **You are pregnant** — foetal risk from plant toxins is high and the test cannot assess it

---

## Related

- [Common Edibles](01-immediate/05-food-emergency/common-edibles) — 20 plants you should learn to identify BEFORE you need them
- [Common Toxics](01-immediate/05-food-emergency/common-toxics) — what to never eat
- [Insects](01-immediate/05-food-emergency/insects) — safer protein source
